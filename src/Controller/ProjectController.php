...
final class ProjectController extends AbstractController
{
    ...
    {
        // Vérification du droit de création du projet
    ...
    {
        // Vérification de l'accès au projet (consultation)
    ...
    {
        // Vérification du droit d'édition du projet
    ...
    {
        // Vérification du droit de suppression du projet
